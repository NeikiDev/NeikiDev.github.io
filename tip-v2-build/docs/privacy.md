...
- To deliver quicker results for files previously analyzed.
- To make file analysis results accessible to all users.
- To analyze usage trends and improve user experience through analytics.

### Data Storage and Security

> All collected data, including file hashes and configuration information, is stored securely in our database.
...
> If harmful or inappropriate data is provided on your public profile, we reserve the right to disable your account and remove related data.

### Opt-Out and Data Deletion

> You may request the deletion of all your data at any time by contacting us via email or by opening a support ticket on our Discord server.
> Upon request, we will provide you with all "personal data" we hold and ensure its complete removal from our systems.
...
> You may choose not to upload files or interact with the site if you do not agree with this policy.
